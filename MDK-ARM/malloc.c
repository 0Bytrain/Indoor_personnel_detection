...
static __ALIGNED(64) uint8_t mem2base[MEM2_MAX_SIZE];                                                         /* 外部SDRAM内存池 */
static __ALIGNED(64) uint8_t mem3base[MEM3_MAX_SIZE];                                                         /* 内部SRAM1+SRAM2内存池 */
// 把 mem3base 固定到 SRAM1/SRAM2 起始地址
//static __ALIGNED(64) uint8_t mem3base[MEM3_MAX_SIZE]
//__attribute__((section(".ARM.__at_0x30000000")));

static __ALIGNED(64) uint8_t mem4base[MEM4_MAX_SIZE];                                                         /* 内部SRAM4内存池 */
static __ALIGNED(64) uint8_t mem5base[MEM5_MAX_SIZE];                                                         /* 内部DTCM内存池 */
static __ALIGNED(64) uint8_t mem6base[MEM6_MAX_SIZE];                                                         /* 内部ITCM内存池 */

/* 内存管理表 - 移除绝对地址分配 */
static MT_TYPE mem1mapbase[MEM1_ALLOC_TABLE_SIZE];                                                            /* 内部SRAM内存池MAP */
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE];                                                            /* 外部SDRAM内存池MAP */
static MT_TYPE mem3mapbase[MEM3_ALLOC_TABLE_SIZE];                                                            /* 内部SRAM1+SRAM2内存池MAP */
static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE];                                                            /* 内部SRAM4内存池MAP */
static MT_TYPE mem5mapbase[MEM5_ALLOC_TABLE_SIZE];                                                            /* 内部DTCM内存池MAP */
static MT_TYPE mem6mapbase[MEM6_ALLOC_TABLE_SIZE];                                                            /* 内部ITCM内存池MAP */
