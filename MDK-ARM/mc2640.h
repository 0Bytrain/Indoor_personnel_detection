...
#define ATK_MC2640_HREF_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)
...
#define ATK_MC2640_D5_GPIO_CLK_ENABLE()         do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)
#define ATK_MC2640_D6_GPIO_PORT                 GPIOB
#define ATK_MC2640_D6_GPIO_PIN                  GPIO_PIN_8
#define ATK_MC2640_D6_GPIO_CLK_ENABLE()         do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)
#define ATK_MC2640_D7_GPIO_PORT                 GPIOB
#define ATK_MC2640_D7_GPIO_PIN                  GPIO_PIN_9
#define ATK_MC2640_D7_GPIO_CLK_ENABLE()         do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)
...
#endif
#define ATK_MC2640_RST_GPIO_PORT                GPIOD
#define ATK_MC2640_RST_GPIO_PIN                 DCMI_RESET_Pin
#define ATK_MC2640_RST_GPIO_CLK_ENABLE()        do{  __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)
#define ATK_MC2640_PWDN_GPIO_PORT               GPIOD
#define ATK_MC2640_PWDN_GPIO_PIN                DCMI_PWDN_Pin
#define ATK_MC2640_PWDNT_GPIO_CLK_ENABLE()        do{  __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)
...
#define ATK_MC2640_SCCB_LIGHT_MODE							0
